...
class Home extends Component {
  ...
  render() {
    ...
    <div className="_home " style={{height:window,width:window}}>
      <div  className="row ">
        <div  className="col-7">
          <h4 className="line-drawing-demo" style={{color:'white',fontWeight: 'bold',paddingTop:80}}> Hi,I'am Asep</h4>
            <h2 className="line-progress" style={{color:'white',fontWeight: 'bold',paddingTop:20,paddingLeft:5}}> WEB DEVELOPER </h2>
          <h2 className="line-progress2" style={{color:'white',fontWeight: 'bold',paddingTop:20,paddingLeft:5}}>MOBILE DEVELOPER</h2>
        </div>
      ...
      <h1 className="line-progress2" style={{color:'white',fontWeight: 'bold',marginTop:100}}>CI/CD Tools</h1>
